...
return [
    'user' => [
        ...
        'ask_admin' => 'Should this user receive the protected Owner access profile?',
        'invalid_admin' => 'The --admin option must be a boolean value such as 1, 0, true, or false.',
        'owner_missing' => 'The protected Owner access profile is missing. Run the database migrations and repair the access-profile data before creating an Owner.',
