...
return [
    'user' => [
        ...
        'ask_admin' => 'Should this user be a Root Admin? (full access, no restrictions)',
        'invalid_admin' => 'The --admin option must be a boolean value such as 1, 0, true, or false.',
        'owner_missing' => 'The Root Admin access profile is missing. Run the database migrations and repair the access-profile data before creating a Root Admin.',
