...
return [
    ...
    'info' => [
        ...
        /*
         * Description rendered on the home page of the API documentation (`/api/docs`).
         */
        'description' => 'Auto-generated from routes, validation rules, and API resources.',
    ],
     ...
     */
    'servers' => [
        'Panel API' => $appUrl ? "{$appUrl}/api" : 'api',
    ],
